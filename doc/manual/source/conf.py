...
copyright = f'2019–{year}, NLnet Labs'
author = 'NLnet Labs'
...
htmlhelp_basename = 'RTRTRUserManualdoc'
...
latex_documents = [
    (master_doc, 'RTRTRUserManual.tex', 'RTRTR User Manual',
     'NLnet Labs', 'manual'),
]
...
man_pages = [
    ('manual-page', 'rtrtr', 'RPKI data proxy',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RTRTRUserManual', 'RTRTR User Manual',
     author, 'RTRTRUserManual', 'One line description of project.',
     'Miscellaneous'),
]
